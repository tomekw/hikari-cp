# hikari-cp ![GitHub Workflow Status](https://img.shields.io/github/actions/workflow/status/tomekw/hikari-cp/clojure.yml?branch=master) [![Clojars Project](https://img.shields.io/clojars/v/hikari-cp.svg)](https://clojars.org/hikari-cp)
