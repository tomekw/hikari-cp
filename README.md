...
| `:jdbc-url`              | **Yes**  | None                   | This property sets a JDBC URL to use in place of a data source.                                                                                                                                                                                                                                                                        |
...
Either `:adapter` or `:jdbc-url` must be specified. HikariCP supports both ways. The data source property is preferred whenever possible.
